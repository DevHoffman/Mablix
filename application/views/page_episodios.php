...
<html>
	...
	<body id="top">
        ...
        <!-- Animes
        ================================================== -->
        <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="<?php echo base_url("assets/animes/" . $Imagem_Destacada) ?>" data-natural-width=1920 data-position-y=center>
