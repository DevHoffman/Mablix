...
<html>
	...
	<body id="top">
        ...
        <!-- Animes
        ================================================== -->
        <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="<?php echo base_url($Imagem_Destacada) ?>" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
