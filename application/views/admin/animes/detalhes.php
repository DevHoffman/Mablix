		...
		<section id="cadastrar" class="s-contact s-usuarios">
	        ...
	        <div class="row section-header ">
				<form id="formdetalhes" novalidate="novalidate">
					...
					<div class="form-group col-12">
						<label class="header-nav_perfil" title="Selecione a Imagem" id="FotoTMP" for="Foto" style="background-image: url('<?php echo base_url("assets/videos/{$anime[0]['Anime']}/banner/{$anime[0]['Imagem_Destacada']}") ?>');">
					...
					<div class="form-group col-12">
						...
						<div class="submit-loader">
							<div class="text-loader">Alterando...</div>
							<div class="s-loader">
