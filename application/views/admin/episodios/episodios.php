	        ...
	        <div class="row section-header ">
				<form id="formdetalhes" novalidate="novalidate">
					...
					<div class="form-group col-12">
	            		...
	            		<input type="hidden" name="anime" value="<?php echo $anime[0]['Anime'] ?>" />
	            		<input type="text" name="episodio" class="Anime" area-required="true" minlength="5" required placeholder="Título do Episódio" />
	        		</div>
				
					<div class="form-group col-12">
	            		<input type="url" name="video" class="video" area-required="true" minlength="5" required placeholder="URL do Episódio" />
	        		</div>
					...
					<div class="form-group col-12">
						<label class="header-nav_perfil" title="Selecione a Imagem" id="FotoTMP" for="Foto" style="background-image: url('<?php echo base_url("assets/images/hero-bg.jpg") ?>');">
							<h2 id="h2-Foto"> Cadastrar imagem </h2>
					...
					<div class="form-group col-12">
						...
						<button type="submit" class="bnt CadastroBtn"> Cadastrar Episódio </button>
						<div class="submit-loader">
							<div class="text-loader">Cadastrando...</div>
							<div class="s-loader">
				...
				$.ajax({
					...
					success: function(msg) {
						if ( msg == 1 ) {
							...
							$('.message-success').html("Episódio cadastrado com Sucesso");
